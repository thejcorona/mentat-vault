---
entity: HER2+ metastatic breast cancer posterior fossa radiotherapy study
type: project
memory_count: 7
...
# HER2+ metastatic breast cancer posterior fossa radiotherapy study
...
- **2026-04-21** — Jackson needs to nail down margin definitions for marginal vs in-field failure post-SRS on the posterior fossa radiotherapy paper — methodological precision work that shapes how outcomes will be coded → [[2026-04-21-13-35-30-Jackson-needs-to-nail-down-margin-definitions-for]]
- **2026-04-21** — Jackson needs to audit his institutional database for completeness before prespecifying variables on the posterior fossa radiotherapy paper — foundational step that determines what variables can actua → [[2026-04-21-13-35-27-Jackson-needs-to-audit-his-institutional-database]]
- **2026-04-21** — Jackson's spot-check audit for posterior fossa radiotherapy paper should focus on three high-risk variables: (1) LMD status — needed to apply baseline exclusion criterion consistently across database;
